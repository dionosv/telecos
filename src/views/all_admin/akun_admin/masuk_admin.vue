      ...
      <form class="space-y-6" @submit.prevent="try_login">
        ...
        <div>
          <button type="submit" :disabled="!akun_email || !akun_sandi"
            class="flex w-full justify-center rounded-md bg-blue-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:bg-gray-400">Masuk</button>
        </div>
      </form>
