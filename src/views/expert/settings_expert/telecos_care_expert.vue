                ...
                <div class="md:flex md:items-center md:justify-between">
                    ...
                    <div class="mt-4 flex md:ml-4 md:mt-0">
                        <RouterLink :to="{ name: 'lapor_telecos_care' }"
                            class="inline-flex items-center gap-x-1.5 rounded-md bg-orange-400 px-2.5 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                ...
                <ul role="list" class="divide-y divide-gray-100" v-for="(ticket, index) in tiket" :key="tiket"
                    ...
                    <li class="flex items-center justify-between gap-x-6 py-5">
                        ...
                        <div class="flex flex-none items-center gap-x-4">
                            <router-link
                                :to="{ name: 'detail_laporan_telecos_care_expert', params: { laporan_id: ticket['id'] } }"
