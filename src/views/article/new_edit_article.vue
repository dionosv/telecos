        ...
        async get_artikel_id() {
            try {
                ...
                if (hasil.status === 1) {
                    ...
                    this.content = hasil.articles[0].content; // Directly assign the content
                    console.log(hasil);
                } else {
                ...
                this.formErrors.push('Terjadi kesalahan saat mengambil data artikel.');
