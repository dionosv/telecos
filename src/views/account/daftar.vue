    ...
    <div class="mt-5 sm:mx-auto sm:w-full sm:max-w-[480px]">
      <div class="bg-white px-6 py-12  sm:rounded-lg sm:px-12">
        ...
        <form class="space-y-6" @submit.prevent="register_next_step">
          ...
          <div>
            <label for="tel" class="block text-sm font-medium leading-6 text-gray-900">Tanggal Lahir</label>
            <div class="mt-2">
          ...
          <div>
            <button type="submit" :disabled="!allFieldsValid"
              class="flex w-full justify-center rounded-md bg-lime-400 px-3 py-1.5 text-sm font-semibold leading-6 text-white hover:bg-lime-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:bg-gray-400">Daftar
              Akun</button>
          </div>
          <!-- <button type="submit" :disabled="" class="flex w-full justify-center rounded-md bg-lime-400 px-3 py-1.5 text-sm font-semibold leading-6 text-white hover:bg-lime-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Daftar Akun</button> -->
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        ...
        <button @click="$emit('change_phase', true)" class="font-semibold text-lime-600 hover:text-lime-800">Masuk
          Sekarang</button>
        <!-- <router-link :to="{ name: 'masuk' }" class="font-semibold text-lime-600 hover:text-lime-800">Masuk
